...
const bootstrapTasks: PlannedBootstrapTask[] = [
  {
    ...
    implementationPlan: [
      ...
      "Replace all placeholder content in overview sections with real answers.",
    ],
    verification: [
  ...
  },
  {
    ...
    implementationPlan: [
      "Complete architecture/foundation/goals.md using concrete and measurable statements.",
  ...
  },
  {
    ...
    implementationPlan: [
      "Fill architecture/foundation/user-journey.md with concrete journey steps.",
  ...
  },
  {
    ...
    implementationPlan: [
      "Complete architecture/foundation/scope.md with explicit boundaries.",
  ...
  },
  {
    ...
    implementationPlan: [
      "Review all architecture/foundation files for completeness and consistency.",
...
export async function initializeProject(options: InitOptions, cwd = process.cwd()): Promise<void> {
  ...
  await writeMarkdownWithFrontmatter(
    ...
    [
      ...
      "## Focus",
      "",
      "- Complete architecture/foundation with project overview, goals, journey, and scope details.",
  ...
  if (!(await pathExists(aiDocsReadmePath))) {
    const aiDocsReadme = [
      ...
      "",
      "1. Read `foundation/` docs first to understand intent and constraints.",
      "2. Read `architecture/` docs for canonical design constraints.",
      "3. Read `standards/` docs before proposing implementation.",
      "4. Use `reference/` docs only for context and examples.",
      "5. Keep documentation updates synchronized with tasks and decisions in `roadmap/`.",
      "6. Verify `.arch/graph.json` reflects expected task/decision/module/domain links.",
    ].join("\n");
