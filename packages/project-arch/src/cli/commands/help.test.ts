...
describe("cli/commands/help", () => {
  ...
  describe("registerHelpCommand", () => {
    ...
    it("should show list of topics when no topic argument provided", async () => {
      ...
      expect(output).toContain("pa runtime check [profileId] [--json]");
      expect(output).toContain("pa agent status <runId>");
    ...
    it("should show commands topic content when requested", async () => {
      ...
      expect(output).toContain("pa runtime list [--json]");
      expect(output).toContain("pa runtime check [profileId] [--json]");
      expect(output).toContain("pa runtime link <runtime> --profile <id> --model <model> [--json]");
